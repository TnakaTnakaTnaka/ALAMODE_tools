...
import optparse
import numpy as np
import disp_openmx_mod as openmx
 ...
 please type\n$ python displace.py -h"
    ...
    if options.OpenMX is None and options.VASP is None and options.QE is None and options.xTAPP is None:
      ...
      options.VASP and options.xTAPP or options.QE and options.xTAPP:
        print "Error : --OpenMX --VASP, --QE, and --xTAPP cannot be given simultaneously."
        exit(1)
    ...
    if code == "OpenMX":
        nat, aa, aa_inv = openmx.read_OpenMX_input(file_original)
